...
import { getWomenProductsByOption } from '@/apis/products.api';
...
const WomenPage: React.FC<WomenPageProps> = (props: WomenPageProps) => {
    ...
    const { data, isLoading, isSuccess, isError } = useQuery({
        ...
        queryFn: async () => await getWomenProductsByOption(page, PAGE_SIZE, option),
    });
    ...
    // useEffect(() => {
    //     if (isSuccess && sortType === '') {
    //         setdata?.data?.data(data?.data?.data);
    //     }
    // }, [data, , isSuccess, sortType]);
                        ...
                        <ul className="inline-flex -space-x-px">
                            <li>
                                {page === 1 ? (
                                    ...
                                    <Link
                                        className="rounded-l-lg mr-3 font-bold border border-gray-300 bg-white py-2 px-3 leading-tight text-gray-500 hover:bg-gray-100 hover:text-gray-700 "
                                        href={`/women?page=${page - 1}`}
                                    >
                                        {`<`}
                                    </Link>
                                )}
                                        ...
                                        <li key={pageNumber}>
                                            <Link
                                                className={classNames(
                                                    'border rounded-full border-gray-300 py-2 px-3 leading-tight hover:bg-gray-100 hover:text-gray-700',
                                                    {
